import{r as s,s as a,j as r,k as u,H as m,B as l}from"./index-438dd456.js";import{B as p}from"./helpers-166c3b16.js";function f(e,n=!0){const o=s.useRef();return s.useEffect(()=>{const t=i=>{o.current&&!o.current.contains(i.target)&&e()};return document.addEventListener("click",t,n),()=>document.removeEventListener("click",t,n)},[e,n]),o}const x=a.div`
  position: fixed;
  top: 50%;
  left: 50%;
