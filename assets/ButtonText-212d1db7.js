import{e as k,f as s}from"./apiBookings-6e9d72e2.js";import{p as B,g as D,s as o,j as e}from"./index-4abb2cda.js";import{f as E,o as M,C,D as P,E as F,l as i}from"./helpers-0e9b145c.js";import{F as N}from"./Flag-24bfd7c5.js";import{i as H}from"./isToday-3134cd30.js";function Y(){const{bookingId:r}=B(),{data:t,isLoading:n,error:a}=D({queryKey:["booking",r],queryFn:()=>k(r),retry:!1});return{booking:t,isLoading:n,error:a}}const $=o.div`
  display: flex;
  align-items: center;
  gap: 1.6rem;
  padding: 0.8rem 0;
