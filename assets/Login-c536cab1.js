import{u as g,a as p,o as x,_ as h,s as l,j as e,r as u,B as j,H as f}from"./index-cab59af1.js";import{u as v}from"./useMutation-b62fbd9b.js";import{F as y,I as c}from"./Form-a43455a1.js";import{S as L,L as b}from"./Logo-23c5bae7.js";import"./iconBase-62ef8db6.js";function w(){const o=g(),s=p(),{mutate:r,isLoading:i}=v({mutationFn:({email:t,password:n})=>x(t,n),onSuccess:t=>{o.setQueryData(["user"],t.user),s("/dashboard",{replace:!0})},onError:t=>{console.log("ERROR",t),h.error("Provided email or password are incorrect")}});return{login:r,isLoading:i}}const S=l.div`
  display: flex;
