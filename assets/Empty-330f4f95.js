import{r as s,s as a,j as r,k as u,H as m,B as l}from"./index-4abb2cda.js";import{B as p}from"./helpers-0e9b145c.js";function f(e,n=!0){const o=s.useRef();return s.useEffect(()=>{const t=i=>{o.current&&!o.current.contains(i.target)&&e()};return document.addEventListener("click",t,n),()=>document.removeEventListener("click",t,n)},[e,n]),o}const x=a.div`
  position: fixed;
  top: 50%;
  left: 50%;
