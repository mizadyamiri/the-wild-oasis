import{e as k,f as s}from"./apiBookings-8f843812.js";import{p as B,g as D,s as o,j as e}from"./index-cab59af1.js";import{f as E,o as M,C,D as P,E as F,l as i}from"./helpers-8b07904d.js";import{F as N}from"./Flag-8fae4170.js";import{i as H}from"./isToday-3d4d0b36.js";function Y(){const{bookingId:r}=B(),{data:t,isLoading:n,error:a}=D({queryKey:["booking",r],queryFn:()=>k(r),retry:!1});return{booking:t,isLoading:n,error:a}}const $=o.div`
  display: flex;
  align-items: center;
  gap: 1.6rem;
  padding: 0.8rem 0;
