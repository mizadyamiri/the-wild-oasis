import{e as k,f as s}from"./apiBookings-fe2cd036.js";import{p as B,g as D,s as o,j as e}from"./index-438dd456.js";import{f as E,o as M,C,D as P,E as F,l as i}from"./helpers-166c3b16.js";import{F as N}from"./Flag-4f9f4dd4.js";import{i as H}from"./isToday-1a768889.js";function Y(){const{bookingId:r}=B(),{data:t,isLoading:n,error:a}=D({queryKey:["booking",r],queryFn:()=>k(r),retry:!1});return{booking:t,isLoading:n,error:a}}const $=o.div`
  display: flex;
  align-items: center;
  gap: 1.6rem;
  padding: 0.8rem 0;
