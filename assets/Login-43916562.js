import{u as g,a as p,o as x,_ as h,s as l,j as e,r as u,B as j,H as f}from"./index-b1bbfbe0.js";import{u as v}from"./useMutation-aadef972.js";import{F as y,I as c}from"./Form-798c48f7.js";import{S as L,L as b}from"./Logo-2cc05431.js";import"./iconBase-18346d96.js";function w(){const o=g(),s=p(),{mutate:r,isLoading:i}=v({mutationFn:({email:t,password:n})=>x(t,n),onSuccess:t=>{o.setQueryData(["user"],t.user),s("/dashboard",{replace:!0})},onError:t=>{console.log("ERROR",t),h.error("Provided email or password are incorrect")}});return{login:r,isLoading:i}}const S=l.div`
  display: flex;
