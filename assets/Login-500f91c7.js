import{u as g,a as p,o as x,_ as h,s as l,j as e,r as u,B as j,H as f}from"./index-04b7707c.js";import{u as v}from"./useMutation-5ff00217.js";import{F as y,I as c}from"./Form-61c0972a.js";import{S as L,L as b}from"./Logo-a41e592b.js";import"./iconBase-b7ff01cd.js";function w(){const o=g(),s=p(),{mutate:r,isLoading:i}=v({mutationFn:({email:t,password:n})=>x(t,n),onSuccess:t=>{o.setQueryData(["user"],t.user),s("/dashboard",{replace:!0})},onError:t=>{console.log("ERROR",t),h.error("Provided email or password are incorrect")}});return{login:r,isLoading:i}}const S=l.div`
  display: flex;
